...
def set_left_arm_base_angle(angle, arduino):
    data = {"action": "l_base", "angle": angle}
...
def set_left_arm_arm1_angle(angle, arduino):
    data = {"action": "l_arm1", "angle": angle}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
    time.sleep(0.2)
    response = arduino.readline().decode().strip()
...
def set_left_arm_arm2_angle(angle, arduino):
    ...
    data = {"action": "l_arm2", "angle": angle}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
    time.sleep(0.2)
    response = arduino.readline().decode().strip()
...
def set_left_arm_wrist_angle(angle, arduino):
    ...
    data = {"action": "l_wrist", "angle": angle}
    json_str = json.dumps(data) + "\n"
...
def set_left_arm_claw_angle(angle, arduino):
    data = {"action": "l_claw", "angle": angle}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
    time.sleep(0.2)
    response = arduino.readline().decode().strip()
...
def set_left_arm_fold_angle(angle, arduino):
    data = {"action": "l_fold_angle", "angle": angle}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())


def set_left_arm_default_position(arduino):
    data = {"action": "l_set_default_position", "angle": "0"}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
...
def left_arm_fold3_object(arduino):
    data = {"action": "l_fold3_object", "angle": "0"}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
    print("Fold3 Object")
...
def left_arm_fold1_object(arduino):
    data = {"action": "l_fold1_object", "angle": "0"}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
    print("Fold1 Object")
...
def left_arm_fold4_object(arduino):
    data = {"action": "l_fold4_object", "angle": "0"}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
    print("Fold4 Object")
...
def left_arm_unfold_arm(arduino):
    data = {"action": "l_unfold_arm", "angle": "0"}
    json_str = json.dumps(data) + "\n"
    arduino.write(json_str.encode())
